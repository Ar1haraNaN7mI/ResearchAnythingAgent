...
interface SessionState {
    ...
    /** When false, PNG export uses opaque white background; default / true = transparent */
...
export function setState(sessionId: string, xml: string, svg?: string): number {
    ...
    stateStore.set(sessionId, {
        ...
        exportPngTransparent: existing?.exportPngTransparent,
        ...
        res.end(
            JSON.stringify({
                ...
                exportPngTransparent:
                    state?.exportPngTransparent !== false,
            }),
        )
            ...
            try {
                ...
                if (data.exportData !== undefined) {
                    ...
                    if (state) {
                        ...
                        state.exportPngTransparent = undefined
                        log.debug(
